...
const ScrambledTitle = React.memo(() => {
    ...
    return (
        <h1
            ref={elementRef}
            className="text-white text-8xl md:text-[12rem] font-extrabold tracking-tighter justify-center uppercase"
...
const RainingLetters: React.FC = () => {
    ...
    return (
        <div className="relative w-full h-full bg-transparent overflow-hidden">
            {/* Title - Moved to Top Middle */}
            <div className="absolute top-24 left-1/2 transform -translate-x-1/2 z-20 w-full flex justify-center px-4">
                <ScrambledTitle />
            </div>
